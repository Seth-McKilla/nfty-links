  ...
  return (
    <div className="fixed h-screen ">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-between w-full h-full px-6 pb-6 space-y-32 ">
          <button
          ...
          <div className="flex flex-col items-start justify-start hidden pb-5 ">
            <button className="flex items-center justify-start px-3 py-2 space-x-6 text-gray-400 rounded hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 w-52">
              <svg
                className="fill-stroke"
                width={24}
                height={24}
